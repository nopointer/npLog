...
public class BigUtils {
    ...
    public static void startBig(int count, BigUtils.Callback callback) {
        mExecutor.execute(() -> {
    ...
    private static List<Integer> create() {
        ...
        result.addAll(CodeUtils.create(35, 5));//红
        result.addAll(CodeUtils.create(12, 2));//篮
        return result;
    }
    ...
    public static String formatHtml(List<Integer> codeList) {
        ...
        stringBuffer.append(codeList.get(codeList.size() - 2)).append(" ");
